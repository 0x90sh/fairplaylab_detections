...
* User‐mode process‐handle detection vector documentation: [https://bible.fairplaylab.org/detection-vectors/usermode-process\_handle](https://bible.fairplaylab.org/detection-vectors/usermode-process_handle)
